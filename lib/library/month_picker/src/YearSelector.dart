...
class YearSelectorState extends State<YearSelector> {
  ...
  Widget _getYearButton(final int page, final int index, final String locale) {
    ...
    return TextButton(
      ...
      style: ButtonStyle(backgroundColor: MaterialStateProperty.all(year == widget.initialDate!.year
          ? Theme.of(context).colorScheme.secondary
          : null), foregroundColor: MaterialStateProperty.all(year == widget.initialDate!.year
