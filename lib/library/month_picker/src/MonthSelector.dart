...
import 'package:interview_test_mahindra/library/month_picker/src/common.dart';
import 'package:interview_test_mahindra/library/month_picker/src/locale_utils.dart';
...
class MonthSelectorState extends State<MonthSelector> {
  ...
  Widget _getMonthButton(final DateTime date, final String locale) {
    ...
    return TextButton(
      style: ButtonStyle(backgroundColor: MaterialStateProperty.all(date.month == widget.selectedDate!.month &&
          date.year == widget.selectedDate!.year
          ? Theme.of(context).colorScheme.secondary
          : null,), foregroundColor: MaterialStateProperty.all(date.month == widget.selectedDate!.month &&
          date.year == widget.selectedDate!.year
